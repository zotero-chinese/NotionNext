const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://wiki.sharestuff.top/' },
    { title: '访问Zotero中文社区文档获取更多帮助', url: 'https://zotero-chinese.com/' }
  ],
  ...
  HERO_TITLE_2: '',
  HERO_TITLE_3: '',
  HERO_TITLE_4: '新版Zotero插件Magic上线',
  HERO_TITLE_5: 'Magic 轻松翻译和总结等功能',
  HERO_TITLE_LINK: 'https://zotero-chinese.com/',
  ...
  INFO_CARD_URL: 'https://github.com/iShareStuff/ShareStuff/wiki', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_3: '加微信isharestuff入群',
  SOCIAL_CARD_URL: 'https://zotero-chinese.com/',
